...
def refresh_intersecting_lines(create_text_command, delete_line):
    ...
    for horizontal_line in horizontal_lines:
        for vertical_line in vertical_lines:
            global_variables.intersecting_lines_and_intersection_point[(vertical_line.point1.x, horizontal_line.point1.y)] = {
                'horizontal line': horizontal_line, 'vertical line': vertical_line}
            try:
                global_variables.point(vertical_line.point1.x, horizontal_line.point1.y, create_text_command,
                                       delete_line)
            except ValueError:
                pass